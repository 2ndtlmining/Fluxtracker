  ...
  <div class="log-header">
    <div class="header-left">
      <div class="title-row">
        ...
        <!-- Icon-only toggles: the name comes from aria-label, the selected state from
             aria-pressed (issue #326); `title` alone is not announced reliably. -->
        <div class="view-toggle" role="group" aria-label="View">
          ...
          <button
            ...
            aria-pressed={viewMode === 'apps'}
            aria-label="App Analytics"
