...
describe('Adapter contract', () => {
    ...
    it('SQLite adapter exports exactly 73 functions', () => {
        expect(sqliteFns).toHaveLength(73);
    });

    it('Supabase adapter exports exactly 73 functions', () => {
        expect(supabaseFns).toHaveLength(73);
    });
...
describe('database.js router', () => {
    ...
    it('re-exports exactly 73 functions', () => {
        expect(routerFns).toHaveLength(73);
    });
});
