...
describe('Adapter contract', () => {
    ...
    it('SQLite adapter exports exactly 91 functions', () => {
        expect(sqliteFns).toHaveLength(91);
    });

    it('Supabase adapter exports exactly 91 functions', () => {
        expect(supabaseFns).toHaveLength(91);
    });
...
describe('database.js router', () => {
    ...
    it('re-exports exactly 91 functions', () => {
        expect(routerFns).toHaveLength(91);
    });
});
