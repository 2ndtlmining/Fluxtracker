...
describe('Adapter contract', () => {
    ...
    it('SQLite adapter exports exactly 96 functions', () => {
        expect(sqliteFns).toHaveLength(96);
    });

    it('Supabase adapter exports exactly 96 functions', () => {
        expect(supabaseFns).toHaveLength(96);
    });
...
describe('database.js router', () => {
    ...
    it('re-exports exactly 96 functions', () => {
        expect(routerFns).toHaveLength(96);
    });
});
