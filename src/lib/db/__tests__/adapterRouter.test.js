...
describe('Adapter contract', () => {
    ...
    it('SQLite adapter exports exactly 89 functions', () => {
        expect(sqliteFns).toHaveLength(89);
    });

    it('Supabase adapter exports exactly 89 functions', () => {
        expect(supabaseFns).toHaveLength(89);
    });
...
describe('database.js router', () => {
    ...
    it('re-exports exactly 89 functions', () => {
        expect(routerFns).toHaveLength(89);
    });
});
